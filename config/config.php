...
$nav = [
    ...
    'like_controller'=>$app_url.'/controllers/LikeController.php',
    'post_model'=>$app_url.'/models/PostModel.php',
    'comment_model'=>$app_url.'/models/CommentModel.php',
    'like_model'=>$app_url.'/models/LikeModel.php',
